                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="#features" className="text-gray-400 hover:text-primary text-sm transition-colors">
                                    Features
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            <a
                                href="#"
                                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-primary hover:bg-white/10 hover:border-primary/50 hover:scale-110 transition-all duration-300"
                                aria-label="Facebook"
                            >
