                            ...
                            {[
                                ...
                                <motion.a
                                    ...
                                    whileHover={{
                                        rotateY: 180,
                                        scale: 1.1,
                                        borderColor: "rgba(255, 75, 125, 0.8)", // Primary pink glow
                                    ...
                                    className="w-12 h-12 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white hover:text-primary transition-colors"
                                >
                                    {/* We wrap the SVG in a motion div to "un-flip" the icon content so it doesn't appear backwards */}
                                    <motion.div
                                        variants={{
                                            hover: { rotateY: 180 }
                                        }}
