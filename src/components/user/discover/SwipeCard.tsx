                        ...
                        <div className="space-y-3">
                            <div className="flex items-end justify-between">
                                ...
                                <button
                                    ...
                                    className="pointer-events-auto p-3 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full text-white transition-all shadow-lg border border-white/20 group/info"
                                >
                                    <Info className="w-6 h-6 group-hover/info:scale-110 transition" />
                                </button>
                            </div>
