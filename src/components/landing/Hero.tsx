const Hero = () => {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black pb-8 sm:pb-12">

      {/* Full-width pill-shaped container */}
      <div className="relative w-full h-screen rounded-[40px] xs:rounded-[60px] sm:rounded-[80px] lg:rounded-[100px] xl:rounded-[120px] overflow-hidden bg-black shadow-2xl border border-white/10 shadow-pink-500/20">

        {/* Background Image - Fully Responsive */}
        <div className="absolute inset-0 opacity-35 xs:opacity-40 sm:opacity-45 md:opacity-50">
          <div
        ...
        <div className="relative h-full flex items-center justify-center px-4 xs:px-6 sm:px-10 md:px-12 lg:px-16 py-6 xs:py-8 sm:py-10 md:py-12">
          ...
          <div className="flex flex-col items-center justify-center text-center space-y-5 xs:space-y-6 sm:space-y-7 md:space-y-8 lg:space-y-10 max-w-4xl mx-auto pt-6 xs:pt-8 sm:pt-10 md:pt-12">
            ...
            <h1 className="text-3xl xs:text-4xl sm:text-[2.75rem] md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight px-2 sm:px-4">
            ...
            <p className="text-base xs:text-lg sm:text-xl md:text-2xl text-white px-2 sm:px-4">
              <span className="font-bold text-primary">1.6 million</span> messages sent daily.
            </p>
            <p className="text-sm xs:text-base sm:text-lg text-gray-300 max-w-2xl leading-relaxed px-4 sm:px-6 md:px-4">
              Connect with like-minded people who share your values, interests, and dreams.
            </p>

            {/* CTA Button - Responsive */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 sm:pt-4 md:pt-6 w-full sm:w-auto px-4 sm:px-0">
            ...
            <div className="flex flex-wrap justify-center gap-2 xs:gap-3 sm:gap-3.5 md:gap-4 pt-3 sm:pt-4 md:pt-6 px-2">
