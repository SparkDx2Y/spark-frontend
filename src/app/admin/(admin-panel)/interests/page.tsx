...
// eth use chayunnathe confirmation Modal state (reuse one confirmation modal for both category and interest)
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="bg-linear-to-b from-white/5 to-transparent border border-white/5 rounded-2xl overflow-hidden">
                        {isLoading ? (
                            <div className="p-8 text-center text-stone-500 text-sm">Loading categories...</div>
                        ) : categories.length === 0 ? (
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {isLoading ? (
                            <div className="col-span-full py-12 text-center text-stone-500 text-sm">Loading interests...</div>
